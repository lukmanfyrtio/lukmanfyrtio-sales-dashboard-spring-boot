...
public interface CustomerInfoRepository extends JpaRepository<CustomerInfo, Long>,QuerydslPredicateExecutor<CustomerInfo>{
	...
	@Query(value="SELECT * FROM customer_info a "
	        + "WHERE a.bup = :bup "
	...
	@Query(value="SELECT * FROM customer_info a "
	        ...
	        + "AND a.leads_status = :leadsStatus", nativeQuery = true)
	List<CustomerInfo> getListByStageBUPAndYear(@Param("bup") String bup,
	        @Param(value = "tahun") Integer tahun,
	...
	@Query(value="SELECT * FROM customer_info a "
	        ...
	        + "AND YEAR(STR_TO_DATE(a.opportunities_open, '%d/%m/%Y')) = :tahun "
	        + "AND a.current_stage = :currentStage "
	        + "AND a.leads_status = :leadsStatus "
	...
	Date getLastUpdate(@Param("bup") String bup
			,@Param(value = "tahun") Integer tahun);
	...
	Date getLastCreated(@Param("bup") String bup
			,@Param(value = "tahun") Integer tahun);
}
